...
长期规则为：放课后扫描周一至周六课表；周一至周五只处理 18:40（含）后开始的课，周六只处理 18:00 前开始的课。课程范围为所有标准芭蕾 L1、标准芭蕾 L1.5，以及课程名归一化后严格等于“软开”或“软开课”的课程；周日、软开专项、软开-胯和其他近似名称均排除。课程层固定为全部芭蕾 L1、全部芭蕾 L1.5、全部软开 / 软开课；每层依次为周六、周一至周五李俊（老师字段为空按李俊）、周一至周五其他老师，各组内按日期和开始时间排序。周六不按老师分层；工作日同名同时段先选李俊老师层，未命中才选其他老师层，每层内仍先在大教室中唯一匹配，大教室为 0 节时再在小教室中唯一匹配。
