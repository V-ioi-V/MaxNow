...
- 第一阶段正在进行会话生命周期验证：2026-07-26 19:07 已在 MaxNow 服务器启动临时隔离单元，19:41 将频率由每 10 分钟降为每 20 分钟；当前 v4 首条交接样本为 HTTP 200 / authenticated，身份失效或连续 3 次未知 / 网络异常即停止。实验仍沿用原始绝对截止时间 2026-08-25 19:07:15，不因迁移重置 30 天上限，服务器重启后不会自动恢复。
