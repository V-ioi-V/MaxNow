...
- 在当前日期 / 农历 / 节日显示之外，补充纪念日、生日等个人特殊日期提醒。
- 明确数据来源：手动维护、日历读取、联系人生日或其他来源，先选择最小可靠方案。
- 当今天没有特殊日期时，保持当前“今日无节日”这类低干扰表达。
- 不把它扩展成完整日历；只服务首页时间卡片的今日提醒。

### 收窄左侧导航栏

- 当前左侧栏在桌面视口占宽偏大，适当缩短宽度，把空间让给主内容区。
- 调整后检查首页、Token 页、窄屏和横向滚动表现，确保菜单文字、图标和选中态不拥挤。
- 保持导航仍然清晰，不做折叠侧栏等额外交互。
