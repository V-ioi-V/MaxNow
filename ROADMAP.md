...
- 阶段 3-4｜无人值守自动抢课：Owner 已明确批准长期周规则与周日 14:20 执行；每周动态扫描周一至周六全天，只处理标准芭蕾 L1 与精确“软开”，不再依赖固定课表。fast path、私有幂等账本、逐课安全结果和 MaxNow 状态面板已完成，见 Done。以后扩展课程类型或日期仍需明确配置、测试和 Owner 授权。
