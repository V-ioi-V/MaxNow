...
- 芭蕾“课程计划”已改为两行四区：宽桌面预约 / 周安排按 1:2，抢课助手 / 上次结果按 1:1；下方完整本周课程表继续保留。课程预约按完整自然日展示最近三个有课日期，周安排按日期、时间与标准课型语义合并预约、课表和 Fast Path 结果，真实课程复用完整课表样式。周安排支持上周、本周、下周三个周一至周日周期；下周执行前显示带小字号真实优先级的待抢目标，执行后由同周真实结果替换。上次结果只保留成功预约、候补中、未抢到总体数量。
