...
- Owner 确认实际上课历史中未填写老师的记录统一按“李俊”处理；闻道明确姓名和 Owner 手工补录姓名保持不变。
- Dashboard 同步、老师聚合和实时上课查询共用同一归一化规则；未来课表、当前预约和候补不套用默认老师。
- 2026-08-14 22:47 实时只读复核闻道 7 月 25 日至 8 月 14 日上课记录：9 条闻道记录中 4 条明确为李俊、1 条老师为空；另有 2 条 Owner 已确认的李俊手工补录，因此应用新规则后李俊共 7 节。
