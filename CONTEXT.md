...
- 2026-08-02 Owner 进一步明确“代抢”不是 Tab：双栏继续同时展示，但两栏顶部改为与“抢课”同族的普通内容标题，使用英文眉题、左对齐中文标题和右侧节数；不再显示居中的粉色胶囊表头。
