...
- 2026-07-31 Owner 将无人值守自动抢课调整为五节固定目标。生产 fast path 周日 14:19:35 启动、14:20:00 提交，固定跨日期优先级仍为周六 > 周日 > 周五 > 其他日期；当前实际顺序是周五李俊软开、周五王嘉豪 L1、周二王嘉豪软开、周二王嘉豪 L1、周四李俊软开，均为大教室晚间课。每节独立执行，可确认安全的临时失败最多重试 3 次；单节失败或 mutation 结果未知继续后续课程，未知 mutation 本身不重试，最后统一核验。身份失效、配置错误或页面结构变化仍全局停止；不自动候补、取消、转课或支付。
