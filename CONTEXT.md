...
- 实际上课历史的老师字段按 Owner 口径归一化：闻道为空时默认补为“李俊”，其中 2026-08-07 19:45–21:15 芭蕾 L1 明确校正为“张瀚泽”；闻道明确姓名与 Owner 手工补录保持原值。实时上课查询和 Dashboard 同步共用该规则，未来课表、当前预约和候补不使用默认老师或历史校正。
