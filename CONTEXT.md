...
- 2026-07-27 14:23 已在不访问闻道、不读取凭据的前提下向服务器私有 ledger 补入 Owner 确认的 2026-07-25 11:30–12:30 李俊软开课；该记录使用 `manual` 稳定键并在前端标记“手动添加”。14:57 实时只读诊断确认源站共有 3 条已预约、1 条排队中和 1 条已上课；排队详情状态“等候中, 排队序号 N”的归一化缺口已修复。手工记录会在后续 full sync 中保留。
