...
- 采集器只允许已确认的只读 GET 页面，包括严格日期格式的课程表路径；禁止调用预约、取消、候补、转课、登录写接口或未知方法。rolling 同步为北京时间每天 `09:00 / 12:00 / 15:00 / 18:00 / 22:00`，周日 14:30 与 20:00 额外同步，月度 full 保持每月 1 日 00:47。
