...
- 自动抢课的跨日期优先级固定为 `周六 > 周日 > 周五 > 其他日期`；同一日期内按开始时间和配置顺序保持确定性。当前目标依次为周五 18:45–19:45 李俊软开大教室、周五 19:45–21:15 王嘉豪芭蕾 L1 大教室、周二 18:45–19:45 王嘉豪软开大教室、周二 19:45–21:15 王嘉豪芭蕾 L1 大教室、周四 18:45–19:45 李俊软开大教室。只预约配置目标；不自动候补、取消、转课、买卡、支付或登录。
