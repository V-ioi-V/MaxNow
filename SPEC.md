...
- Token 近期活动：Home 主内容区左侧上方展示近 90 天每日 Token 活动热力格，替代原“当前主线”列表；顶部状态条仍保留 7 天 Token 小摘要。
...
- personal-wiki 近期待办入口：Home 主内容区左侧下方的紧凑只读模块，用于填补 Token 热力格下方空间、查看近期未完成待办并跳转到 personal-wiki；v1 不支持编辑或标记完成。
