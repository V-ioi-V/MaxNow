...
- Owner 已确认：实际上课历史中闻道未填写老师的记录默认按“李俊”处理，并进入李俊的老师分布；2026-07-30 18:45–19:45 的软开课明确校正为“王嘉豪”，2026-08-07 19:45–21:15 的芭蕾 L1 明确校正为“张瀚泽”。闻道明确填写的其他老师和 Owner 手工补录的老师保持原值。默认值与明确校正只用于已上课历史，不套用到未来课表、当前预约或候补。
