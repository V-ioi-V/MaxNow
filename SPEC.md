...
- 自动抢课先按课程优先级 `芭蕾 L1 > 软开` 排序，再在同一课程内按日期优先级 `周六 > 周日 > 周五 > 其他日期` 排序；同课程、同日期内按开始时间和配置顺序保持确定性。当前实际顺序依次为周日 20:00–21:30 芭蕾 L1 大教室、周五 19:45–21:15 芭蕾 L1 大教室、周二 19:45–21:15 芭蕾 L1 大教室、周日 19:00–20:00 软开大教室、周五 18:45–19:45 软开大教室、周二 18:45–19:45 软开大教室、周四 18:45–19:45 软开大教室，七项目标均不限老师。只处理配置目标：可预约则预约，可排队则候补；不取消、转课、买卡、支付或登录。
...
- 新规则默认先以 `off` / `dry-run` 验证；Owner 也可以对明确列出的课程、顺序和时间单独批准直接进入 `enabled`，但必须在规格、配置和更新记录中留下该次授权边界。2026-07-31 Owner 已明确批准原五节课；2026-08-08 又明确批准新增周日 19:00–20:00 软开与 20:00–21:30 芭蕾 L1 两节大教室目标。跨日期仍沿用 2026-07-28 已批准的周六 > 周日 > 周五 > 其他日期长期顺序。
