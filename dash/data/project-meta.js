window.MAXNOW_PROJECT_META_DATA = {
  "schemaVersion": 1,
  "updatedAt": "2026-07-26 21:01",
  "version": "1.0.4.17",
  "versionLabel": "v1.0.4.17",
  "branch": "feature/ballet-module-detail-plan",
  "commit": "305061d",
  "dirty": true,
  "dirtyLevel": "code",
  "deployNote": "feature/ballet-module-detail-plan · commit 305061d · 有未提交代码改动",
  "recentUpdates": [
    {
      "date": "2026-07-26",
      "title": "完善芭蕾学习模块的缓存、统计与视觉方案",
      "summary": "确认未来导航顺序为 Home → 芭蕾 → 豆奶 → Token → 云服务 → 生活 → 同行记；芭蕾页标题为“芭蕾 / 课程与进度”，使用区别于同行记亮粉的粉玫瑰 + 白卡语义，Home 只保留下一节课、本周进度和同步状态摘要。"
    },
    {
      "date": "2026-07-26",
